...
#     data = pd.get_dummies(data, columns=['country', 'sex', 'source', 'browser'])
#     return data
...
#     save_processed_data(final_data, 'data/processed/process.csv')
...
if __name__ == "__main__":
    ...
    merged_data = normalize_and_scale(merged_data)
    final_data = encode_categorical_features(merged_data)
    save_processed_data(final_data, '/data/processed/processed_Fraud.csv')
